        ...
        {!isSubmitted ? (
          <form onSubmit={handleResetPassword}>
            ...
            <div className="resetbuttoncontainer mb-6">
              <button
                type="submit"
                className="resetpasswordbtn w-full bg-blue-600 text-white py-2 px-4 rounded-md hover:bg-blue-700 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                disabled={isLoading}
              >
